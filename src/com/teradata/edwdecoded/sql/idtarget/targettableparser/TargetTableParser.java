/* TargetTableParser.java */
/* Generated By:JavaCC: Do not edit this line. TargetTableParser.java */
package com.teradata.edwdecoded.sql.idtarget.targettableparser;

import com.teradata.edwdecoded.sql.idtarget.Debug;

public class TargetTableParser implements TargetTableParserConstants {

  final public String idTarget() throws ParseException {String target = null;
    if (jj_2_1(2)) {
      parseUsingClause();
    } else {
      ;
 ...
 */
  final public void parseUsingClause() throws ParseException {
    jj_consume_token(USING);
Debug.println ("Using (");
    if (jj_2_12(2)) {
      jj_consume_token(OPEN_PAREN);
      parseUsingDeclOptionalParen();
Debug.println();
      label_2:
      while (true) {
        if (jj_2_10(2)) {
...
Debug.println (") End of using");
    } else if (jj_2_13(2)) {
      parseUsingDeclMandatoryParen();
Debug.println();
      label_3:
      while (true) {
        if (jj_2_11(2)) {
 ...
 */
  final public void parseUsingDeclOptionalParen() throws ParseException {
    jj_consume_token(IDENTIFIER);
Debug.print ("  optional paren " + token.image + " ");
    if (jj_2_16(2)) {
      parseDataType();
      label_4:
      while (true) {
 ...
 * Parse a single column/variable declaration within the larger using clause.
 */
  final public void parseUsingDeclMandatoryParen() throws ParseException {
    jj_consume_token(IDENTIFIER);
Debug.print ("  mandatory paren " + token.image + " ");
    jj_consume_token(OPEN_PAREN);
    parseDataType();
    label_6:
    while (true) {
  ...
  final public void parseDataType() throws ParseException {String str;
    if (jj_2_50(2)) {
      if (jj_2_19(2)) {
        ...
        jj_consume_token(VARBYTE);
      } else {
        jj_consume_token(-1);
        throw new ParseException();
      }
Debug.print ("Byte: " + token.image);
      if (jj_2_22(2)) {
        jj_consume_token(OPEN_PAREN);
        jj_consume_token(LITERAL_INTEGER);
Debug.print (" size: " + token.image);
        jj_consume_token(CLOSE_PAREN);
      } else {
        ;
      }
...
Debug.print (")");
  ...
  final public void parseDateTime() throws ParseException {String str;
    if (jj_2_60(2)) {
      jj_consume_token(DATE);
...
Debug.print (str);
  ...
  final public void parseInterval() throws ParseException {
...
Debug.print (" TO MONTH");
  ...
  final public void parseTypeAttribute() throws ParseException {String str = "";
    if (jj_2_82(2)) {
      if (jj_2_76(2)) {
...
str = "not ";
        ...
        jj_consume_token(CASESPECIFIC);
Debug.print (" " + str + "casespecific");
      } else if (jj_2_80(2)) {
        jj_consume_token(UPPERCASE);
Debug.print (" uppercase" );
      } else if (jj_2_81(2)) {
...
Debug.print (" character set " + token.image);
  ...
  final public void parseLockingClause() throws ParseException {
    jj_consume_token(LOCKING);
Debug.print ("Locking Clause: " + token.image + " ");
    if (jj_2_88(2)) {
      if (jj_2_87(2)) {
        if (jj_2_84(2)) {
          jj_consume_token(DATABASE);
        } else if (jj_2_85(2)) {
          jj_consume_token(TABLE_LCK);
        } else if (jj_2_86(2)) {
      ...
      jj_consume_token(DATABASE_OBJECT_NAME);
Debug.print( "DB/TBL/VIEW " + token.image + " ");
    } else if (jj_2_89(2)) {
...
Debug.println();
  ...
  final public void parseTemporalClause() throws ParseException {
    if (jj_2_109(2)) {
      jj_consume_token(CURRENT);
      jj_consume_token(VALIDTIME);
Debug.println ("Temporal - current validtime");
    } else if (jj_2_110(2)) {
      if (jj_2_102(2)) {
        jj_consume_token(SEQUENCED);
Debug.print ("Sequenced ");
      } else {
        ;
      }
      jj_consume_token(VALIDTIME);
Debug.println ("Temporal - validtime");
      if (jj_2_108(2)) {
        jj_consume_token(PERIOD);
Debug.print ("Temporal PERIOD ");
        jj_consume_token(SINGLE_QUOTE);
        jj_consume_token(OPEN_PAREN);
        jj_consume_token(PERIOD_BOUND);
Debug.print (" from " + token.image);
        if (jj_2_103(2)) {
        ...
        if (jj_2_105(2)) {
          ...
          jj_consume_token(UNTIL_CHANGED);
        } else if (jj_2_107(2)) {
          jj_consume_token(UNTIL_CLOSED);
        } else {
          jj_consume_token(-1);
          throw new ParseException();
        }
Debug.println (" to " + token.image);
      ...
      jj_consume_token(NONSEQUENCED);
      jj_consume_token(VALIDTIME);
Debug.println ("Temporal - nonsequenced validtime");
    } else if (jj_2_112(2)) {
      jj_consume_token(NONTEMPORAL);
Debug.println ("Temporal - nontemporal");
    } else {
      jj_consume_token(-1);
      throw new ParseException();
    }
  ...
  final public String parseInsert() throws ParseException {String target;
    if (jj_2_113(2)) {
...
//                          and to simplify the code a bit
  final public String parseUpdate() throws ParseException {String target = "";
...
Debug.println("Processing update of form <BASIC, NO FROM>");
      ...
      targetTblOrAlias = jj_consume_token(IDENTIFIER);
      if (jj_2_116(2)) {
...
{if ("" != null) return target;}
  ...
  final public String parseUpdateFromTables(Token targetTblOrAlias, String prevTarget) throws ParseException {String target = prevTarget;
Token updTable = null;
Token updAlias = null;
    updTable = jj_consume_token(IDENTIFIER);
if (targetTblOrAlias.image != null && updTable.image != null
    ...
    updAlias = jj_consume_token(IDENTIFIER);
if (targetTblOrAlias.image != null && updAlias.image != null
...
{if ("" != null) return target;}
  ...
  final public String parseDelete() throws ParseException {String target = null;
Token correlationNameToken = null;
Token fromTableNameToken = null;
Token asCorrelationNameToken = null;
    if (jj_2_135(2)) {
      fromTableNameToken = jj_consume_token(IDENTIFIER);
      if (jj_2_122(2)) {
        if (jj_2_121(2)) {
          jj_consume_token(AS);
        } else {
        ...
        asCorrelationNameToken = jj_consume_token(IDENTIFIER);
      } else {
        ;
      }
      if (jj_2_123(2)) {
      ...
      if (jj_2_127(2)) {
        correlationNameToken = jj_consume_token(IDENTIFIER);
      } else {
        ;
      }
      if (jj_2_128(2)) {
...
Debug.println("Delete parsed...");
  ...
  final public String parseMerge() throws ParseException {String target;
    if (jj_2_137(2)) {
      jj_consume_token(INTO);
    } else {
      ;
...
{if ("" != null) return target;}
  ...
  final public String parseCreate() throws ParseException {String target;
    if (jj_2_140(2)) {
      if (jj_2_138(2)) {
        jj_consume_token(SET);
      } else if (jj_2_139(2)) {
...
{if ("" != null) return target;}
 ...
 {
    if (jj_scan_token(CT)) return true;
    if (jj_scan_token(IDENTIFIER)) return true;
    return false;
  }
 ...
 {
    if (jj_scan_token(CHECKSUM)) return true;
    return false;
  }
 ...
 {
    if (jj_scan_token(UNTIL_CLOSED)) return true;
    return false;
  }
 ...
 {
    if (jj_scan_token(UNTIL_CHANGED)) return true;
    return false;
  }

  private boolean jj_3_105()
 {
    if (jj_scan_token(PERIOD_BOUND)) return true;
    return false;
  }

  private boolean jj_3_112()
 {
    if (jj_scan_token(NONTEMPORAL)) return true;
    return false;
  }
 ...
 {
    if (jj_scan_token(NONSEQUENCED)) return true;
    if (jj_scan_token(VALIDTIME)) return true;
    return false;
  }
 ...
 {
    if (jj_scan_token(SEQUENCED)) return true;
    return false;
  }
 ...
 {
    if (jj_scan_token(TABLE_LCK)) return true;
    return false;
  }
  ...
  private boolean jj_3_88()
 {
    ...
    if (jj_scan_token(DATABASE_OBJECT_NAME)) return true;
    return false;
  }

  private boolean jj_3R_9()
 {
    if (jj_scan_token(LOCKING)) return true;
    Token xsp;
    xsp = jj_scanpos;
    if (jj_3_88()) {
    jj_scanpos = xsp;
  ...
  private boolean jj_3_79()
 {
    ...
    if (jj_scan_token(CASESPECIFIC)) return true;
    return false;
  }
 ...
 {
    if (jj_scan_token(VARGRAPHIC)) return true;
    return false;
  }
 ...
 {
    if (jj_scan_token(VARBYTE)) return true;
    return false;
  }
 ...
 {
    if (jj_scan_token(BYTEINT)) return true;
    return false;
  }
  ...
  private boolean jj_3_139()
 {
  ...
  public TargetTableParserTokenManager token_source;
  ...
  final private JJCalls[] jj_2_rtns = new JJCalls[143];
  private boolean jj_rescan = false;
  private int jj_gc = 0;

  /** Constructor with InputStream. */
  public TargetTableParser(java.io.InputStream stream) {
	  this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public TargetTableParser(java.io.InputStream stream, String encoding) {
	 try { jj_input_stream = new SimpleCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
	 token_source = new TargetTableParserTokenManager(jj_input_stream);
	 token = new Token();
	 jj_ntk = -1;
	 jj_gen = 0;
  ...
  /** Constructor. */
  public TargetTableParser(java.io.Reader stream) {
 ...
 token_source = new TargetTableParserTokenManager(jj_input_stream);
  ...
  public TargetTableParser(TargetTableParserTokenManager tm) {
	 token_source = tm;
	 token = new Token();
	 jj_ntk = -1;
	 jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(TargetTableParserTokenManager tm) {
	 token_source = tm;
	 token = new Token();
	 jj_ntk = -1;
	 jj_gen = 0;
