...
public class TargetTableParser implements TargetTableParserConstants {
  ...
  final public String idTarget() throws ParseException {
String target = null;
    if (jj_2_1(2)) {
      parseUsingClause();
    } else {
...
String str;
  ...
  final public void parseDateTime() throws ParseException {
String str;
    if (jj_2_60(2)) {
      jj_consume_token(DATE);
  ...
  final public void parseTypeAttribute() throws ParseException {
String str = "";
    if (jj_2_82(2)) {
      if (jj_2_76(2)) {
...
Token asCorrelationNameToken = null;
  ...
  final public String parseMerge() throws ParseException {
String target;
    if (jj_2_138(2)) {
      jj_consume_token(INTO);
    } else {
  ...
  final public String parseCreate() throws ParseException {
String target;
    if (jj_2_141(2)) {
      if (jj_2_139(2)) {
        jj_consume_token(SET);
